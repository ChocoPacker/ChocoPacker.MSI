...
namespace ChocoPacker.MSI.Windows.Tests
{
    public class MsiInstallerInfoProviderTests
    {
        ...
        public void GetInstallerInfo_CorrectMsi_DataObtained()
        {
            ...
            Assert.Equal("msiexec /i \"NTVS 1.2 Alpha VS 2015.msi\" /qn REBOOT=ReallySuppress", info.InstallString);
            ...
            Assert.Equal("msiexec /x {8FD8CF77-9630-4CDA-98A6-6BEA8A85F0A9} /qn REBOOT=ReallySuppress", info.UninstallString);                                                
        }
